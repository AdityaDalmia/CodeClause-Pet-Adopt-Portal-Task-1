...
function validateForm() {
  var name = document.forms["adoption-form"]["name"].value;
  var email = document.forms["adoption-form"]["email"].value;
  var phone = document.forms["adoption-form"]["phone"].value;
  var pet = document.forms["adoption-form"]["pet"].value;
  var message = document.forms["adoption-form"]["message"].value;
  ...
  alert("Thank you for submitting the adoption form!");
  return true;
}
